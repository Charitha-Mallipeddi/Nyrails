# ruff: noqa: UP031,TRY003,SLF001,EM101,PLR0912,PLR0915,SIM105,C901,PTH119,PTH122,B028,FBT002
import gzip
import os
import warnings
    ...
    def handle(self, *app_labels, **options):
            ...
            for model in models:
                ...
                if not model._meta.proxy and router.allow_migrate_model(using, model):
                    ...
                    if hasattr(model._meta, "ordering"):
                        queryset = objects.using(using).order_by(*model._meta.ordering)
                    else:
        ...
        try:
            ...
            if output:
                ...
                compression_formats: dict[str, tuple] = {
                    ".bz2": (open, {}, file_root),
                    ".gz": (gzip.open, {}, output),
                    ".lzma": (open, {}, file_root),
                    ".xz": (open, {}, file_root),
